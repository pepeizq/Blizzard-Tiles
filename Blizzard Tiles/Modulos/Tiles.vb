...
Module Tiles
    ...
    Public Async Function DescargaImagen(imagen As ImageEx, clave As String) As Task(Of Boolean)
        ...
        If TypeOf fuente Is Uri Then
            Dim enlace As Uri = fuente

            If enlace.AbsolutePath.Contains("/Assets/Juegos") Then
                Dim ficheroOrigen As StorageFile = Await StorageFile.GetFileFromApplicationUriAsync(enlace)
