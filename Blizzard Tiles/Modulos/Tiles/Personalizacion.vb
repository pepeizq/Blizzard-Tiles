...
Namespace Tiles
    Module Personalizacion
        ...
        Public Async Sub Cargar(grid As Grid, tipo As Integer, fuente As String)
            ...
            Dim cbImagenLogo As CheckBox = pagina.FindName("cbPersonalizacionImagenLogo")

            If Not cbImagenLogo Is Nothing Then
                cbImagenLogo.IsChecked = True
                cbImagenLogo.Tag = tipo

                RemoveHandler cbImagenLogo.Checked, AddressOf CambiarImagenLogo_Checked
                AddHandler cbImagenLogo.Checked, AddressOf CambiarImagenLogo_Checked

                RemoveHandler cbImagenLogo.Unchecked, AddressOf CambiarImagenLogo_Unchecked
                AddHandler cbImagenLogo.Unchecked, AddressOf CambiarImagenLogo_Unchecked
            End If
        ...
        Private Sub CambiarImagenLogo_Checked(sender As Object, e As RoutedEventArgs)
        ...
        Private Sub CambiarImagenLogo_Unchecked(sender As Object, e As RoutedEventArgs)
