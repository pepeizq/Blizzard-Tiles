...
Public NotInheritable Class MainPage
    ...
    Private Sub Nv_Loaded(sender As Object, e As RoutedEventArgs)
        ...
        nvPrincipal.MenuItems.Add(MasCosas.Generar("https://github.com/pepeizq/Blizzard-Tiles", "https://poeditor.com/join/project/suaRhCuaWT", "https://www.youtube.com/watch?v=TxcD3E6X-5A"))
